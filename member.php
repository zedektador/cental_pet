...
$pet3 = $_POST["pet3"];
	...
	if($count_email > 0 ){
		...
		$sql ="INSERT INTO `membership_tbl` (`member_id`, `firstname`, `lastname`, `email`,  `mobile`, `address` ,'pet1' ,'pet2' ,'pet3') VALUES (NULL, '$firstname', '$lastname', '$email',  '$mobile', '$address' ,'$pet1' ,'$pet2' ,'$pet3')";
		...
		";
			...
			header('Refresh:0; admin_profile.php');
		}
	}
	} 
