    ...
    <title>Order History</title> 
      ...
      <div class="collapse navbar-collapse navHeaderCollapse">
            ...
            <ul class="nav navbar-nav navbar-right ">
                ...
                <li><a href="#" style="text-decoration:none; color:#74ACB3;"><span class="  glyphicon glyphicon-send"></span> Customers Order</a></li>
...
<p><br></p>
           ...
           <br /><br />  
           <div class="container">  
               <h1 align="center">Customers Order<br> <br> 
               </h1> 
                          ...
                          {  
                               ...
                               <tr>  
                                    ...
                                    <td>'.$row["address"].'</td>  
                                     ...
                                     <a href="deliver_up.php?send=1&id='.$row["item_id"].'" class="btn btn-sm btn-warning"><span class="glyphicon glyphicon-wrench"></span>Send message</a>
                                     </td>
