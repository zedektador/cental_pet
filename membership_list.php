 <?php  
include('connect.php');
$query = "SELECT * From membership_accept";
...
<p><br></p>
           ...
           <br /><br />  
           <div class="container">  
               <h1 align="center">Membership List</h1> 
...
if(isset($_POST["btnn1"])){
  ...
  $sql = "INSERT INTO `membership_accept` (`member_id`, `firstname`, `lastname`, `mobile`, `address`, `email`, `pet1`, `pet2`,`pet3`) VALUES (NULL, '$name', '$lastname', '$mobile', '$address', '$email', '$pet1', '$pet2', '$pet3');";
