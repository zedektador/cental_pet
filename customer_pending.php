...
include('connect.php');
session_start();
$query = "SELECT * From reserve GROUP by user_id" ;
...
<p><br></p>
           ...
           <br /><br />  
           <div class="container">  
               <h1 align="center" style="font-weight: bold;">Customers Payment for Reserve<br> <br> 
               </h1> 
                          ...
                          {  
                               ...
                               <tr>  
                                    ...
                                    <td>'.$row["address"].'</td>  
                                     ...
                                     <a href="customer_payment.php?titi=1&id='.$row["id"].' " class="btn btn-info"><span class="glyphicon glyphicon-ok-sign"></span> View</a>
