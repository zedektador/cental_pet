      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="panel panel-info">
            <div class="panel-heading" style="text-align: center; background : #00b3b3;">Membership Form</div>
            <div class="panel-body">
              ...
              <?php
                  ...
                  if(isset($_POST['tite'])){
                    ...
                    $sql = " INSERT INTO `pet_central`.`membership_tbl` (`member_id`, `firstname`, `lastname`, `email`, `mobile`, `address`, `pet1`, `pet2`, `pet3` , 'payment')VALUES (NULL, '$firstname', '$lastname', '$email', '$mobile', '$address', '$pet1', '$pet2', '$pet3' , '$payment' ); ";
                    $run = mysqli_query($con,$sql);
