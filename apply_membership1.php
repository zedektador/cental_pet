      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="panel panel-info">
            <div class="panel-heading" style="text-align: center; background-color:#00b3b3; color:white;">Membership Form</div>
            <div class="panel-body">
              ...
              <?php
                  ...
                  if(isset($_POST['tite'])){
                    ...
                    $sql = " INSERT INTO `pet_central`.`membership_tbl` (`member_id`, `firstname`, `lastname`, `email`, `acct_num`, `payment`, `pet1`, `pet2`, `pet3`) VALUES (NULL, '$firstname', '$lastname', '$email', '$acct_num', '$payment', '$pet1', '$pet2', '$pet3'); ";
                    $run = mysqli_query($con,$sql);
                    ...
                    if ($run) {
                      ...
                      echo "<script>window.location='customer_homepage.php';</script>";                   
                    }
