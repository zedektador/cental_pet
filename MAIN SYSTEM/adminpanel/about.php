							  ...
							  <table class="table table-hover">
							    <thead>
							      <tr>
							        ...
							        <th>Who are Robin Joy's House of Flowers</th>
							        <th>What is Robin Joy's House of Flowers</th>
							        <th>Action</th>
							      </tr>
							    </thead>
							    <tbody>
							      <tr>
							        <?php 
							            $qry = mysqli_query($conn, "SELECT * FROM tbl_admin_about"); // query the data inside database
							            while ($row=mysqli_fetch_array($qry,MYSQLI_ASSOC)) {
							              echo '<tr><td>'.$row["admin_about_welcome"].'</td>';

							              echo '<td>'.$row["admin_about_quote"].'</td>';

							              echo '<td>'.$row["admin_about_about"].'</td>';
;

							             echo '<td><a href="?edit='.$row['id'].'"> Edit</a></td></tr>';
							            }
							           ?>
							      </tr>
