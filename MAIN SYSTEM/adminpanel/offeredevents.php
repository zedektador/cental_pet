...
<head>
	...
	<link rel="stylesheet" type="text/css" href="offeredevents.css">
	<!-- end: CSS -->
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="icon-align-justify"></i><span class="break"></span>Offered events</h2>
						<div class="box-icon">
	...
	<div class="modal hide fade" id="myModal">
		...
		<div class="modal-body">
			<form class="form-horizontal">
			    ...
			    <div class="col-sm-11">
			      <input type="text"  class="form-control" id="inputtext3" placeholder="Event Type">
			    </div>
			     <div class="form-group">
