<?php 
	...
	if (isset($_POST['button_admin'])) {
							$qry = mysqli_query($conn, "UPDATE events SET title='".$_POST['event_title']."' WHERE id='".$_POST['id']."'"); // update data from database when 'edit button' is clicked
						}

					if (isset($_GET['delete'])) { 
						$qry = mysqli_query($conn, "DELETE FROM events WHERE id='".$_GET['delete']."'"); // delete data from database when 'delete' is clicked
						
					}
					elseif (isset($_GET['edit'])) {
						$qry = mysqli_query($conn, "SELECT * FROM events WHERE id='".$_GET['edit']."'");
...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="admin-details.php"><span>Robin Joy's House of Flowers</span></a>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<input type="text" name="id" value="<?php echo $cid ?>">
			<input type="text" name="event_title" value="<?php echo $ctitle ?>">
							    ...
							    <tbody>
							      <tr>
							        <?php 	
										...
										$qryget = "SELECT * FROM events ORDER BY date";
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2017 <a href="http://themifycloud.com/downloads/janux-free-responsive-admin-dashboard-template/" alt="Bootstrap_Metro_Dashboard">Robin Joy House Of Flowers</a></span>
