...
<html lang="en">
	<head>
		...
		<title>Robin Joy's House of Flower</title>
		...
		<link href="css/offeredvenue.css" rel="stylesheet">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
					          ...
					          <ul class="dropdown-menu">
					            ...
					            <li role="separator" class="divider"></li>
					            <li><a href="bapismal.php">Baptismal</a></li>
					            <li role="separator" class="divider"></li>
							...
							<li><a href="offeredpackages.php">Offered Packages</a></li>
					         <li><a href="#offeredvenue">Offered Venues</a></li>
					...
					<div class="col-md-12">
						<div class="st-home-unit">
							<div class="hero-txt">
								...
								<h2 class="hero-title animated bounceInDown">Offered Venues</h2>
								...
								<a href="#" class="btn btn-main btn-lg">Inquiry</a>
							</div>
