<?php  
 ...
 $query1 = "SELECT * FROM item WHERE start BETWEEN  '".$d1."' AND '".$d2."' ";
 ...
 ?>
  ...
  $query2 = "SELECT SUM(payment) as sum FROM item WHERE start BETWEEN '".$d1."' AND '".$d2."' ";
