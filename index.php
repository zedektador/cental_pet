...
<div class="navbar navbar navbar-fixed-top" style="background-color: #00b3b3;color: white;">
		<div class="container-fluid">
          ...
          <!--<li><a href="service_list.php" style="padding-top: 23px;color: white;"><span class="glyphicon glyphicon-modal-window"></span> Services</a></li>-->
			...
			<div class="collapse navbar-collapse navHeaderCollapse">
				...
				<li><a href="admin_login.php" style="padding-top: 23px;color: white;" ><span class="glyphicon glyphicon-user" style="color: white;"></span> Admin</a></li>
				 	...
				 	<li><a href="admin_login.php" class="dropdown-toggle" data-toggle="dropdown" style="padding-top: 20px;color: white;"><span class="glyphicon glyphicon-user" style="padding-top: 4px;color: white;"></span> Log-In</a>
	...
	<div id="get_category">
		...
		<div class="nav nav-pills nav-stacked">
			<li class="active"><a href="#"><h4>Services</h4></a></li>
				<li><a href="#">Aircon Types</a></li>
			1	<li><a href="#">Aircon Types</a></li>
				<li><a href="#">Aircon Types</a></li>
		</div> -->
	</div>
		<div class="col-md-8">
				<div class="panel panel-info">
					<div class="panel-heading" style="background-color: #00b3b3; color:white;">Products / Services</div>
