...
//brand sql
	...
	echo "
				<div class='nav nav-pills nav-stacked'>
					<li class='active'><a href='#' style='background-color: #00b3b3;'><h4>Services</h4></a></li>
	";
	if(mysqli_num_rows($run_query)>0){
		while($row=mysqli_fetch_array($run_query)){
			$bid = $row["brand_id"];
				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='image/$pro_image' style='width:100%; height:100%;' /><br><div class='title_pro'>$pro_desc</div><br><br><b>Stock :$qty</b>
 				...
 				elseif(isset($_POST["cart_checkout"])){
					...
					echo "
 						<div class='row'>
								...
								<div class='col-md-2'><img src='image/$pro_image' width='110' height='80'></div><br>
