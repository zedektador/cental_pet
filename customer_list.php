...
<p><br></p>
    ...
    <a href="delete_update.php?edited=1&id='.$row["user_id"].'" class="btn btn-primary"><span class="glyphicon glyphicon-ok-sign"></span></a>
    
      <a href="delete_update.php?delete=1&id='.$row["user_id"].'" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
